...
class Dashboard extends BaseController {
    ...
    public function setFields(){
        ...
        $args = array(
            ...
            array(
                'id' => 'add_cart_text',
                'title' => 'Text of cart button <a href="https://addonsplus.com/downloads/woocommerce-sticky-add-to-cart-bar-pro/" class="get-pro" target="_blank" >Get Pro Feature</a><div class="tooltip">?<div class="tipbox"><p>Text that is on add to cart button.</p><i></i></div></div>',
                'callback' => array( $this->callbacks_form , 'textField' ),
                'page' => 'woo_cart',
                'section' => 'appearance',
                'args' => array(

<div class="wrap">
	<div class="title">
		...
		<div style="margin-top: 15px; margin-bottom: 15px;">We need your support to keep updating and improving the plugin. <a target="_blank" href="https://wordpress.org/support/plugin/sticky-add-to-cart-bar-for-wc/reviews/?filter=5#new-post"><b>Please, help us by leaving a good review <span class="dashicons  dashicons-star-filled" style="color:#dba617"></span><span class="dashicons  dashicons-star-filled" style="color:#dba617"></span><span class="dashicons  dashicons-star-filled" style="color:#dba617"></span><span class="dashicons  dashicons-star-filled" style="color:#dba617"></span><span class="dashicons  dashicons-star-filled" style="color:#dba617"></span></a></b> Thanks!</div>
		<?php settings_errors();  ?>
	</div>
